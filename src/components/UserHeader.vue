    ...
    <div class="mx-auto flex justify-between">
      ...
      <nav class="space-x-2 flex place-content-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5"
          stroke="currentColor" class="w-6 h-6 text-orange-400" @click="openNotificationListModal">
          <path stroke-linecap="round" stroke-linejoin="round"
            d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0"
            fill="currentColor" />
        </svg>
        <NotificationListModal :isModalNotificaitonOpen="isModalNotificaitonOpen"
          @close-modal="isModalNotificaitonOpen = false" class="absolute right-0 mt-6 mr-6" />
