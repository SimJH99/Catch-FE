      ...
      <div>
        <div class="m-3 grid grid-cols-5">
          <div class="bg-white m-2 p-2 rounded-md py-5 px-4">
            <div class="flex">
              <div class="text-xl font-bold text-gray-500 mr-2">총 방문자 수</div>
              <div>
          ...
          <div class="bg-white m-2 p-2 rounded-md py-5 px-4">
            <div class="flex">
              <div class="text-xl font-bold text-gray-500 mr-2">발송 메일 총 건수</div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
              </svg>
            </div>
            <a href="">
              <div class="m-5 text-4xl font-bold text-center"> 54039건 </div>
            </a>
          </div>
          
          <div class="bg-white m-2 p-2 rounded-md py-5 px-4">
            <div class="flex">
              <div class="text-xl font-bold text-gray-500 mr-2">알림 총 건수</div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500">
